...
<div class=" mydiv">
    ...
    <form method="post" action="{{route('gym-managers.update',$user->id)}}"
        ...
        <div class="text-center">
            <label for="avatar" class="form-label" role="button">
                <img class="profile-user-img img-fluid img-circle" src="{{asset('images/'. $user->avatar . '')}}"
                    alt="User profile picture">
            </label>
            <input type="file" name="avatar" id="avatar" class="d-none" value="{{$user->avatar}}"
